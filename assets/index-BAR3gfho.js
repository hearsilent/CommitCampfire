 ...
 */const V=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),Z=t=>t.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,o,r)=>r?r.toUpperCase():o.toLowerCase()),R=t=>{const e=Z(t);return e.charAt(0).toUpperCase()+e.slice(1)},H=(...t)=>t.filter((e,o,r)=>!!e&&e.trim()!==""&&r.indexOf(e)===o).join(" ").trim(),Q=t=>{for(const e in t)if(e.startsWith("aria-")||e==="role"||e==="title")return!0};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const X=l.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:o=2,absoluteStrokeWidth:r,className:a="",children:n,iconNode:i,...u},p)=>l.createElement("svg",{ref:p,...W,width:e,height:e,stroke:t,strokeWidth:r?Number(o)*24/Number(e):o,className:H("lucide",a),...!n&&!Q(u)&&{"aria-hidden":"true"},...u},[...i.map(([h,d])=>l.createElement(h,d)),...Array.isArray(n)?n:[n]]));/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tt=(t,e)=>{const o=l.forwardRef(({className:r,...a},n)=>l.createElement(X,{ref:n,iconNode:e,className:H(`lucide-${V(R(t))}`,`lucide-${t}`,r),...a}));return o.displayName=R(t),o};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
